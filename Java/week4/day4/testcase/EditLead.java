...
public class EditLead extends BaseLead{
	/* Extends from BaseLead Class
	  ...
	  * @Test from EditLead Class will be executed
	  * Postconditions() from BaseClass will be executed after @Test
	  */

	@Test(dependsOnMethods= "week4.day4.testcase.CreateLead.createLead")
	public void editLead() throws InterruptedException {
		
		//BaseLead class preCondition() will be executed before @Test
